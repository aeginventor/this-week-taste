...
#
# **소스가 주는 전부가 아니라 우리 범위만 긁는다.** CU는 `70` 생활용품을
# 같이 주는데(주당 746건, 21요청) 티슈·바디로션·가그린·콘돔이 거기 있다. 정찰 표를
# 그대로 옮겨 놓았다가 2026-08-24에 사이트에 실려서 걷어냈다.
...
# 정찰 2026-08-11 실측. 식음료 6개 카테고리 4,262건 / 110요청.
# (생활용품 838건 / 21요청을 뺀 값이다. 정찰 당시 총계는 5,082건 / 131요청이었다.)
# **첫 수집 때만 쓰는 부트스트랩 기준이다** (`pipeline/snapshot.py` 참조).
BOOTSTRAP_COUNTS = {
    "10": 208, "20": 101, "30": 1154, "40": 225, "50": 1686, "60": 888,
}
