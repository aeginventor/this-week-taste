  ...
  return (
    <article className="prose">
      ...
      <p>
        ...
        이전 관측과 비교합니다. 새 항목은 과거 관측과 대조한 뒤 발견 기록으로 정리합니다.
      </p>
      <p>
        목록에 새로 등장하거나 &lsquo;NEW&rsquo;가 붙었다는 사실만으로 출시를 확정하지
        않습니다. 공식 출처에서 해당 제품의 출시 사실과 시점이 함께 확인되어야 합니다.
        현재 발행 기록에는 이 근거가 없어 출시 미확인으로 표시합니다.
      </p>
